        ...
        <div class="filter-sections">
            <div class="filter-section">
              ...
              <div>
                ...
                <input type="checkbox" id="societe1" value="Societe 1">
              </div>
              <div>
                <label class="checkbox-label" for="societe2">Société 2</label>
                <input type="checkbox" id="societe2" value="Societe 2">
              </div>
            </div>
            ...
            <div class="filter-section">
              ...
              <div>
                ...
                <input type="checkbox" id="domaine1" value="Domaine 1">
              </div>
              <div>
                <label class="checkbox-label" for="domaine2">Domaine 2</label>
                <input type="checkbox" id="domaine2" value="Domaine 2">
              </div>
            </div>
            ...
            <div class="filter-section">
              ...
              <div>
                ...
                <input type="checkbox" id="source1" value="Source 1">
              </div>
              <div>
                <label class="checkbox-label" for="source2">Source 2</label>
                <input type="checkbox" id="source2" value="Source 2">
              </div>
            </div>
            ...
            <div class="filter-section">
              ...
              <div>
                ...
                <input type="checkbox" id="support1" value="Support 1">
              </div>
              <div>
                <label class="checkbox-label" for="support2">Support 2</label>
                <input type="checkbox" id="support2" value="Support 2">
              </div>
            </div>
